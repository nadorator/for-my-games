...
### Added
- Implemented RESTful API based on microservices architecture
- Created three microservices: User Service, Content Service, and Auth Service
- Added Domain-Driven Design (DDD) structure with proper separation of concerns
- Implemented JWT-based authentication for editors
- Added role-based authorization (admin and moderator roles)
- Created comprehensive domain models: Visitor, Editor, Game, and Content
- Implemented database schema with MariaDB
- Added nginx as API gateway with proper routing
- Created comprehensive API documentation in README.md

### Changed
- Restructured project to follow DDD principles
- Updated Docker configuration to support microservices
- Enhanced security with JWT-based authentication
- Improved database schema with proper relationships and constraints

### Dependencies
- Added Firebase JWT library for authentication
- Added Ramsey UUID library for generating UUIDs
